...
To apply for inclusion into the Sandbox, projects should submit an issue into the (sandbox)[https://www.github.com/cncf/sandbox] repo to be added to the queue.
